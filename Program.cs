...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "5":
            ...
            Console.WriteLine("Enter the ID of the animal you want to update the age for:");
            readResult = Console.ReadLine();
            string updateID = readResult?.ToLower() ?? "";

            bool foundAnimal = false;
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0].ToLower().Contains(updateID))
                {
                    foundAnimal = true;
            ...
            if (!foundAnimal)
            {
                Console.WriteLine("Animal not found with the given ID.");
            }
        ...
        case "6":
            ...
            Console.WriteLine("Enter the ID of the animal you want to update the personality for:");
            readResult = Console.ReadLine();
            updateID = readResult?.ToLower() ?? "";
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                {
                    foundAnimal = true;
                    Console.WriteLine($"Current {ourAnimals[i, 5]}");
                    Console.WriteLine("Enter the new personality description:");
                    readResult = Console.ReadLine();
                    animalPersonalityDescription = readResult?.ToLower() ?? "tbd";
                    ourAnimals[i, 5] = "Personality: " + animalPersonalityDescription;
        ...
        case "7":
            //Disaplay all cats with specifies Characterstics;
            Console.WriteLine("Enter a characteristic to search for in cats:");
            readResult = Console.ReadLine();
            string catCharacteristic = readResult?.ToLower() ?? "";

            Console.WriteLine("\nCats matching the characteristic:");
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].ToLower().Contains("cat") &&
                    (ourAnimals[i, 4].ToLower().Contains(catCharacteristic) || ourAnimals[i, 5].ToLower().Contains(catCharacteristic)))
                {
                    Console.WriteLine();
                    for (int j = 0; j < 6; j++)
                    {
        ...
        // Display all dogs with a specified characteristic
            ...
            readResult = Console.ReadLine();
            string dogCharacteristic = readResult?.ToLower() ?? "";

            Console.WriteLine("\nDogs matching the characteristic:");
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].ToLower().Contains("dog") &&
                    (ourAnimals[i, 4].ToLower().Contains(dogCharacteristic) || ourAnimals[i, 5].ToLower().Contains(dogCharacteristic)))
                {
                    Console.WriteLine();
                    for (int j = 0; j < 6; j++)
                    {
